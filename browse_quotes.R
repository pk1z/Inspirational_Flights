...
#                                                                                                                         #
# usage:                                                                                                                  #
# ~$ Rscript browse_quotes.R './data' '20170508_215017_1' 'HU' 'HUF' 'hu-HU' 'BUDA' 'LOND' '2017-05' '{apikey}' '2017-05' #
#                                                                                                                         #
###########################################################################################################################
...
link1 <- paste('http://partners.api.skyscanner.net/apiservices/browsequotes/v1.0', co, cu, lo, orp, dep, oupd, sep = '/')
...
outfile <- paste('quotes_', orp, '_', dep, '_', tn, '.csv', sep = '')
